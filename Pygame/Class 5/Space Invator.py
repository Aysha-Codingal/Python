...
for _i in range(num_of_enemies):
    ...
    enemyY.append(random.radint(ENEMY_START_Y_MIN, ENEMY_START_Y_MAX))
...
def show_score(x, y):
    score = font.rendar("Score : " + str(score_value), True, (255, 255, 255))
    screen.blit(score, (x, y))

def game_over_text():    
    over_text = over_font.rendar("GAME OVER", True, (255, 255, 255))
